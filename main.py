"""
RugDetector — Rug pull detection using on-chain pattern matching + LLM
...
log = logging.getLogger("rugdetector")
...
class Router:
    """Cost- and latency-aware model router for RugDetector."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="RugDetector: Rug pull detection using on-chain pattern matching + LLM")
